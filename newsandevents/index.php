    ...
    <main id="home">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <P>All events posted here are hosted and facilited by South Eastern Kenya University and its
                    partners</p>
...
<h3 class="mt-2 text-center">If you would like contact us about an event <a class="nav-link"
                                                                            href="<?php echo BASE_PATH ?>/about"><h4
                class="mt-2 text-center">CLICK HERE</h4></a></h3>
